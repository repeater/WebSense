	...
	<div data-role="content" class="wsPage">
        ...
        <div data-role="collapsible-set" data-theme="c" data-content-theme="d" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
			...
			<div data-role="collapsible" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
				...
				<p>An optional remote filter agent provides web access to remote users for protection against threats and enforcement of policies.</p>
			</div>
			<div data-role="collapsible" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
				<h3>Malware Sandbox Services and Forensic Analysis</h3>
				<p>Optional Websense CyberSecurity Intelligence&trade; (CSI) services include the Websense ThreatScope&trade; service, which provides detailed forensic analysis of malware in a safe sandbox environment.</p>
			</div>
		</div>
    </div>
