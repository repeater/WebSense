...
<div data-role="header" id="wsHeader" data-position="fixed">
	...
	<div data-role="content" class="wsPage">
		<h1 class="ui-title">Neil Thacker</h1>
		<h2>EMEA Information Security and Strategy Officer</h2>
		<p><a href="mailto:nthacker@websense.com">nthacker@websense.com</a></p>
        <p>
        Neil Thacker joined Websense in 2012 and holds the position of EMEA information security and strategy officer.
        </p>
        <p>
