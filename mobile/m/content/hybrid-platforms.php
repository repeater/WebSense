...
<div data-role="page" class="wsShadow">
	...
	<div data-role="content" class="wsPage">
		<h1>Hybrid</h1>
        <h2>Combine deployment options and manage on a single console.</h2>
        <p>
        <b>Websense TruHybrid&trade; deployment offers the best of all worlds.</b> Get the unique advantages of both in-the-cloud and on-premises information security — and manage the entire system from a single console. TruHybrid deployment solves several key web security challenges by:
        </p>
        <ul class="standard">
            <li>Providing high-capacity appliances or software to meet the demands of large offices. </li>
            <li>Using the cloud to secure smaller satellite offices that lack the technical resources to support hardware. </li>
            <li>Securing mobile users in the cloud so there's no need to route traffic back to a central location. </li>
        </ul>
        <br />
        <h4>TruHybrid offers advantageous email security: </h4>
        <ul class="standard">
            <li>Bulk inbound email is filtered in the cloud, reducing your need for on-premises hardware to carry the load </li>
            <li>Websense V-Series&trade; appliances provide control for customized policies, granular reporting and outbound data loss prevention (DLP) </li>
        </ul>
        <br />
        <h4>Advantages:</h4>
        <ul class="standard">
        ...
        <ul class="standard">
            <li><a href="websense-triton-security-gateway-anywhere-features.php">TRITON&trade; Security Gateway Anywhere </a></li>
            <li><a href="websense-triton-enterprise-features.php">TRITON&trade; Enterprise</a></li>
            <li><a href="email-security-gateway-anywhere-features.php">Email Security Gateway Anywhere</a></li>
            <li><a href="web-security-gateway-anywhere-features.php">Web Security Gateway Anywhere </a></li>
        </ul>
	</div>
