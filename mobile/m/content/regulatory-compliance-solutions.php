...
<div data-role="page">
	...
	<div data-role="content" class="wsPage">
        ...
        <h2>Websense helps you manage constantly changing complexity.</h2>
		...
		<ul class="standard tight">
			...
			<li>Enforcement of web, secure web and email traffic. </li>
			<li>Confidential data discovery using both local and network scans. </li>
			<li>Single management console. </li>
		</ul>
		<h4>Data Security Suite features include:</h4>
		...
		<ul class="tight standard">
			...
			<li>Policy wizards, configuration templates and more.</li>
		</ul>
