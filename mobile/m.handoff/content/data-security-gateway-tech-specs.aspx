...
<div data-role="page" class="wsShadow">
	...
	<div data-role="content" class="wsPage">
		...
		<div class="techSpecs">
			...
			<h2>Websense<sup>&reg;</sup> V-Series™ Appliance Platform</h2>
			<div class="techSpecs">
				<h2>Websense V5000&trade; G2</h2>
				<h3 class="first">Designed for</h3>
				<ul class="standard no-margin tight no-padding">
					<li>SMB and branch offices</li>
					<li>Enterprise </li>
				</ul>
				<h3>Maximum Users</h3>
				<p>5,000</p>
				...
				<h3>Dimensions</h3>
				<ul class="standard no-margin no-padding tight">
					<li>1U form factor, 27 lbs. (12.25 Kg)</li>
					<li>15.5" D x 17.1" W x 1.67" H</li>
					<li>39.5 cm D x 43.43 cm W x 4.24 cm H </li>
				</ul>
				<h3>Hardware Support</h3>
				<ul class="standard no-margin no-padding tight">
					<li>Next business day on-site support (included) </li>
					<li>4-hour on-site support  (optional)</li>
					<li>24/7 global phone support (Premium Support customers only)</li>
				</ul>
				<h3>Regulatory and Compliance</h3>
				<ul class="standard no-margin no-padding tight">
					<li>FCC/ICES/EN55022/VCCI/
					BSMI/C-Tick/SABS/CCC/MIC
					Class A and UL60950/ CAN/
					CSA/EN60950/IEC60950 - 1 </li>
					<li>Verified to comply with EU RoHS Directive</li>
					<li>Energy consumption and noise emissions in accordance with ISO 9296 </li>
				</ul>
				<h3>Availability</h3>
				<p>More than 70 countries</p>
			</div>
			<div class="techSpecs">
				<h2>Websense V10000&trade; G3</h2>
				<h3 class="first">Designed for</h3>
				<ul class="standard no-margin tight no-padding">
					<li>Enterprise</li>
					<li>Large offices</li>
				...
				<h3>Dimensions</h3>
				<ul class="standard no-margin no-padding tight">
					<li>1U form factor, 39 lbs. (16.3 Kg)</li>
					<li>30.39" D x 18.99" W x 1.68" H</li>
					<li>77.2 cm D x 48.24 cm W x 4.26 cm H </li>
				</ul>
				<h3>Hardware Support</h3>
				<ul class="standard no-margin no-padding tight">
					<li>24/7 global phone support (included)</li>
					<li>4-hour on-site support (included)</li>
				</ul>
				<h3>Regulatory and Compliance</h3>
				<ul class="standard no-margin no-padding tight">
					<li>FCC/ICES/EN55022/VCCI/
			...
			<a href="/assets/datasheets/datasheet-data-security-gateway-en.pdf" data-shadow="false" data-role="button" data-mini="true" class="wsBButton" target="_parent">View datasheet</a>
			<a href="/assets/pdf/ProductComparison.pdf" data-shadow="false" data-role="button" data-mini="true" class="wsBButton" target="_parent">Related products</a>
    	</div>
    </div>
