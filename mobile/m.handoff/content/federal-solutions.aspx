...
<div data-role="page">
	...
	<div data-role="content" class="wsPage">
        ...
        <p>You face myriad data security requirements and must block multiple attack vectors while meeting regulations for FISMA, DIACAP, DITSCAP and others. Websense helps protect data across the range of target vectors, while also providing insight into both blocked malicious activity and enabled standard activity. Our products and platforms meet demanding compliance standards for federal security requirements, including <a href="#common-criteria" data-rel="popup" data-position-to="window" data-inline="true" data-transition="pop">Common Criteria</a>, FIPS 140-2, HSPD#12 and DOD/Army STIG. Plus, Websense enables compliance with Department of Defense requirements for use of social media (<a href="/assets/solutions/solution-brief-DoD-social-media-compliance-en.pdf" title="DoD DTM 09-026 Compliance" class="trackable omni_Other" target="_blank">learn more</a>).</p>
        <ul class="standard tight">
            <li><a href="/assets/pdf/product-comparison-chart.pdf" target="_parent">Compare</a> our data security products. </li>
        </ul>
        <h4>Websense<sup>&reg;</sup> ACE (Advanced Classification Engine) is why no one stops more threats than Websense.</h4>
        <p>ACE delivers real-time security ratings to all products built on the Websense TRITON<sup>&reg;</sup> architecture. Its seven assessment areas and a unique composite scoring process enable our products to detect things other security solutions miss while providing inline, real-time advanced threat protection. <strong></strong></p>
        <ul class="standard tight">
            <!--<li><a href="security-overview-websense-ace.aspx">Read</a> the ACE white paper.</li>-->
            <li><a href="websense-advanced-classification-engine.aspx">Visit</a> the ACE web pages. </li>
            <li><a href="/assets/pdf/product-comparison-chart.pdf" target="_parent">Compare</a> our web security gateway products. </li>
        </ul>
        <h4>Enabling the safe and productive use of social media. </h4>
        <p>
        The social web is essential to your working relationships and public image. But it also introduces risk and saps your bandwidth. Websense can help ensure your employees use the social web safely and effectively.
        </p>
        <ul class="standard tight">
            <!--<li><a href="social-media-acceptable-use-policy.aspx">Download</a> our free social media acceptable use policy (AUP) toolkit and adapt it for your organization.</li>-->
            <li><a href="social-web-security-solutions.aspx">Learn how</a> Websense can protect your organization and its staff on the social web.</li>
        </ul>
        ...
        <div data-role="popup" id="common-criteria" data-overlay-theme="a" class="ui-corner-all wsModal">
			<div data-role="content" class="ui-corner-bottom ui-content">
				...
				<div class="modCenter">
					...
					<a href="http://www.cse-cst.gc.ca/its-sti/services/cc/websense-v76-eng.html" data-role="button" data-inline="true" class="wsBButton" target="_blank">Continue</a>
				</div>
			</div>
		</div>
    </div>
