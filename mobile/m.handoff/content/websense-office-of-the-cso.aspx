...
<div data-role="page">
	...
	<div data-role="content" class="wsPage">
		...
		<a href="what-were-reading.aspx" data-shadow="false" data-role="button" data-mini="true" class="wsBButton" data-transition="slide">View Recommended Books</a>
		...
		<ul id="cso-experts">
			<li>
				<a href="jason-clark.aspx" data-transition="slide"><img alt="" src="/assets/imgs/2013/ws2013-cso-jason-clark.png" /></a>
				<p>
				<span class="name">Jason Clark</span> <br />
				Chief Security and Strategy Officer<br />
				<a href="jason-clark.aspx" data-transition="slide">View profile</a></p>
			</li>
			<li>
				<a href="brenda-santos.aspx" data-transition="slide"><img alt="" src="/assets/imgs/2013/ws2013-cso-brenda-santos.png" /></a>
				<p>
				<span class="name">Brenda Santos</span> <br />
				Information Security &amp; Strategy Officer (US)<br />
				<a href="brenda-santos.aspx" data-transition="slide">View profile</a></p>
			</li>
			<li>
				<a href="neil-thacker.aspx" data-transition="slide"><img alt="" src="/assets/imgs/2013/ws2013-cso-neil-thacker.png" /></a>
				<p>
				<span class="name">Neil Thacker</span> <br />
				Information Security &amp; Strategy Officer (EMEA) <br />
				<a href="neil-thacker.aspx" data-transition="slide">View profile</a></p>
			</li>
			<li>
				<a href="james-robinson.aspx" data-transition="slide"><img alt="" src="/assets/imgs/2013/ws2013-cso-james-robinson.png" /></a>
				<p>
				<span class="name">James Robinson</span> <br />
				Security Architect<br />
				<a href="james-robinson.aspx" data-transition="slide">View profile</a></p>
			</li>
			<li>
				<a href="max-grossling.aspx" data-transition="slide"><img alt="" src="/assets/imgs/2013/ws2013-cso-max-grossling.png" /></a>
				<p>
				<span class="name">Max Grossling</span> <br />
				Sr. Technical Program Manager<br />
				<a href="max-grossling.aspx" data-transition="slide">View profile</a></p>
			</li>
			<li>
				<a href="lamont-orange.aspx" data-transition="slide"><img alt="" src="/assets/imgs/2013/ws2013-cso-lamont-orange.png" /></a>
				<p>
				<span class="name">Lamont Orange</span> <br />
				Sr. Director, Information Security<br />
				<a href="lamont-orange.aspx" data-transition="slide">View profile</a></p>
			</li>
			<li>
				<a href="dave-baker.aspx" data-transition="slide"><img alt="" src="/assets/imgs/2013/ws2013-cso-dave-baker.png" /></a>
				<p>
				<span class="name">Dave Baker</span> <br />
				Vice President of Information Technology <br />
				<a href="dave-baker.aspx" data-transition="slide">View profile</a></p>
			</li>
		</ul>
