...
<div data-role="page" class="wsShadow">
	...
	<div data-role="content" class="wsPage">
		<h1>Web Security Gateway</h1>
        <h2>Real-time, inline protection against today's advanced threats.</h2>
        ...
        <a href="web-security-gateway-tech-specs.aspx" data-shadow="false" data-role="button" data-mini="true" class="wsBButton" data-transition="slide">Tech Specs</a>
        <h4>Top Features</h4>
        <ul class="standard">
        ...
        <div data-role="collapsible-set" data-theme="c" data-content-theme="d" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
			...
			<div data-role="collapsible" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
				<h3>Easy Addition of Email Security</h3>
				<p>Web Security Gateway integrates with all Websense Email Security solutions. They share a single administrative interface, and management services including user directory synchronization, delegated administration, reporting, account management and ACE defenses.</p>
			</div>
			<div data-role="collapsible" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
		...
		<a href="/assets/datasheets/datasheet-web-security-gateway-en.pdf" data-shadow="false" data-role="button" data-mini="true" class="wsBButton" target=_parent">Download a datasheet</a>
