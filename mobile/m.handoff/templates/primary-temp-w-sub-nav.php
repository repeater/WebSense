...
<!-- begin header -->
	<div data-role="header" id="wsHeader" data-position="fixed">
		...
		<div class="wsTitle">
			<h2><a href="/content/proveit.php" alt="TRITON stops more threats. We can prove it.">TRITON stops more threats. We can prove it.<span></span></a></h2>
		</div>
	</div>
<!-- end header -->
<!-- begin nav panel -->
		...
		<div data-role="collapsible-set" data-inset="false" data-theme="a" data-content-theme="d">
			<div data-role="collapsible" data-content-theme="d">
				...
				<ul data-role="listview" data-filter-theme="d" data-theme="a">
					...
					<li class="navThree"><a href="/content/data-security-suite-features.php">Data Security Suite</a></li>
					<li class="navThree"><a href="/content/data-security-gateway-features.php">Data Security Gateway</a></li>
					<li class="navThree"><a href="/content/data-discover-features.php">Data Discover</a></li>
					<li class="navThree"><a href="/content/data-endpoint-features.php">Data Endpoint</a></li>
					<li class="navTwo"><a href="/content/websense-mobile-security-products.php">Mobile Security Products</a></li>
					...
					<li class="navThree"><a href="/content/websense-master-database.php">Master Database</a></li>
					<li class="navTwo"><a href="/content/websense-platforms.php">Platforms</a></li>
					<li class="navThree"><a href="/content/appliances-platforms.php">Appliance</a></li>
			...
			<div data-role="collapsible">
				...
				<ul data-role="listview" data-filter-theme="d" data-theme="a" data-divider-theme="b">
					<li class="navOne"><a href="/content/solutions-center.php">Solutions Overview</a></li>
					<li class="navThree"><a href="/content/enterprise-solutions.php">Enterprise</a></li>
					<li class="navThree"><a href="/content/smb-solutions.php">Small and Medium Business</a></li>
					<li class="navThree"><a href="/content/federal-solutions.php">Federal</a></li>
					<li class="navThree"><a href="/content/finance-and-banking-solutions.php">Finance and Banking</a></li>
					<li class="navThree"><a href="/content/health-care-solutions.php">Health Care</a></li>
					<li class="navThree"><a href="/content/k-12-education-solutions.php">K12 Education</a></li>
					<li class="navThree"><a href="/content/higher-education-solutions.php">Higher Education</a></li>
					<li class="navThree"><a href="/content/regulatory-compliance-solutions.php">Compliance</a></li>
					<li class="navThree"><a href="/content/social-web-security-solutions.php">Social Media</a></li>
				</ul>
			</div>
			<div data-role="collapsible">
				<h3>Company</h3>
