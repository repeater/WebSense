...
<div data-role="page" class="wsShadow">
	...
	<div data-role="content" class="wsPage">
        ...
        <p>Websense<sup>&reg;</sup> TRITON&trade; Security Gateway provides industry-leading web security with email security that has built-in DLP capabilities. You can
        ...
        <p><a href="email-security-gateway-features.php">Email Security Gateway</a></p>
        <ul class="standard">
