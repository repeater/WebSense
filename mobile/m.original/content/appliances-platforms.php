...
<div data-role="page" class="wsShadow">
	...
	<div data-role="content" class="wsPage">
        ...
        <a href="../assets/pdf/ProductComparison.pdf" data-shadow="false" data-role="button" data-mini="true" class="wsBButton">Download a Data Sheet</a>
        ...
        <p><b>Optimized for performance and reliability</b>. Websense appliances are preconfigured to meet specified performance requirements. They also include unique clustering technology that can simplify deployment of redundant, load-balanced clusters.</p>
		<h4>Advantages</h4>
		<ul class="standard">
		...
		<p><b>Websense<sup>&reg;</sup> V-Series&trade; appliances</b> are powerful and flexible yet simple to deploy. V-Series appliances support web security, email security and data security on a single appliance. <a href="v-series-appliances.php">Learn more &gt;</a></p>
		<p><b>The Websense<sup>&reg;</sup> X-Series&trade; appliance</b> is the only secure web gateway with enough power for large enterprises to run the real-time contextual defenses needed for effective containment of advanced attacks and data theft. <a href="x10g-applances.php">Learn more &gt;</a></p>
	</div>
