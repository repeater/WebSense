...
<html>
<head>
	<title>WebSense - AceInsight ThreeatScope Report - Version 3</title>
	...
	<div class="nav">
		<form name="fargform">
			<select name = "farg" onChange = "iljval()">
				<option>Report 1 v3</option>
				<option>Report 2 v3</option>
				<option>Report 3 v3</option>
				<option>Report 4 v3</option>
				<option>Report 5 v3</option>
				<option>Report 6 v3</option>
