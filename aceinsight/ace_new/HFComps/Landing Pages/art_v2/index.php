	...
	<div class="nav">
		<form name="fargform">
			<select name = "farg" onChange = "iljval()">
				<option>Screen 1 v2</option>
				<option>Screen 2 v2</option>
				<option>Screen 3 v2</option>
				<option>Screen 4 v2</option>
				<option>Screen 5 v2</option>
				<option>Screen 6 v2</option>
				<option>Screen 7 v2</option>
				<option>Screen 8 v2</option>
				<option>Screen 9 v2</option>
			</select>
		</form>
	</div>
